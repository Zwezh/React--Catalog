    ...
    return (
        <div className="panel panel-default">
            <div className="panel-heading">
                <h2>Здeсь должен находиться контент главной страницы</h2>
            </div>
            <div className="panel-body">
                <p>Lorem ipsum dolor sit amet,consetetur sadipscing elitr,  sed diam voluptua.  consetetur sadipscing elitr,  Stet clita kasd gubergren,  sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat,  sed diam voluptua.  Stet clita kasd gubergren,  At vero eos et accusam et justo duo dolores et ea rebum.  sed diam voluptua.</p>
                <p>Lorem ipsum dolor sit amet,sed diam voluptua.  At vero eos et accusam et justo duo dolores et ea rebum.  consetetur sadipscing elitr,  sed diam voluptua.  sed diam voluptua.  consetetur sadipscing elitr,  sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat,  consetetur sadipscing elitr,  sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                <p>Lorem ipsum dolor sit amet,no sea takimata sanctus est Lorem ipsum dolor sit amet.  At vero eos et accusam et justo duo dolores et ea rebum.  Stet clita kasd gubergren,  consetetur sadipscing elitr,  no sea takimata sanctus est Lorem ipsum dolor sit amet.  consetetur sadipscing elitr,  Stet clita kasd gubergren,  At vero eos et accusam et justo duo dolores et ea rebum.  consetetur sadipscing elitr</p>
